...
class DataUtils:
    @classmethod
    def object_to_database_dict(cls, entity, obj, time_format=Consts.TIME_FORMAT, include=(), exclude=()) -> Dict:
        result = {}
    ...
    def objects_to_database_dict(
        cls, entity, objs, time_format=Consts.TIME_FORMAT, include=(), exclude=()
    ) -> List[Dict]:
        return [
