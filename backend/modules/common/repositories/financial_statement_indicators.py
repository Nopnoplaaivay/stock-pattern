...
from backend.modules.common.entities import FinancialStatementIndicatorEntity


class FinancialStatementIndicatorRepo(BaseRepo[FinancialStatementIndicatorEntity]):
    entity = FinancialStatementIndicatorEntity
