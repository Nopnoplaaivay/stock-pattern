...
from backend.modules.common.entities import IndexSectorIndicatorEntity


class IndexSectorIndicatorRepo(BaseRepo[IndexSectorIndicatorEntity]):
    entity = IndexSectorIndicatorEntity
