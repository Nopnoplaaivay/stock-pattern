...
class StockEntity(Base):
    ...
    taxCode = sqlalchemy.Column(sqlalchemy.VARCHAR(1024))
    ...
    exchangeCode = sqlalchemy.Column(sqlalchemy.VARCHAR(36))
    sector = sqlalchemy.Column(sqlalchemy.NVARCHAR(None))
