...
from backend.modules.data_explorer.corporate.entities import TradingDataDailyEntity


class TradingDataDailyRepo(BaseRepo[TradingDataDailyEntity]):
    entity = TradingDataDailyEntity
