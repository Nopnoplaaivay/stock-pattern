...
class DEISFinancialRatiosPerShareRatiosEntity(Base):
    __tablename__ = "financialRatiosPerShareRatios"
    ...
    RTD0001 = sqlalchemy.Column(sqlalchemy.FLOAT)
    RTD0004 = sqlalchemy.Column(sqlalchemy.FLOAT)
    RTD0007 = sqlalchemy.Column(sqlalchemy.FLOAT)
    RTD0008 = sqlalchemy.Column(sqlalchemy.FLOAT)
    RTD0011 = sqlalchemy.Column(sqlalchemy.FLOAT)
    RTD0013 = sqlalchemy.Column(sqlalchemy.FLOAT)
