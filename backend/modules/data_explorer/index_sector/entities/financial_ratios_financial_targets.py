...
class DEISFinancialRatiosFinancialTargetsEntity(Base):
    __tablename__ = "financialRatiosFinancialTargets"
    ...
    RTD0064 = sqlalchemy.Column(sqlalchemy.FLOAT)
    RTD0065 = sqlalchemy.Column(sqlalchemy.FLOAT)
