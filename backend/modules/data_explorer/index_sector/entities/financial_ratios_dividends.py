...
class DEISFinancialRatiosDividendsEntity(Base):
    __tablename__ = "financialRatiosDividends"
    ...
    RTD0045 = sqlalchemy.Column(sqlalchemy.FLOAT)
    RTD0046 = sqlalchemy.Column(sqlalchemy.FLOAT)
