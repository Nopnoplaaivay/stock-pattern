...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosDividendsEntity


class DEISFinancialRatiosDividendsRepo(BaseRepo[DEISFinancialRatiosDividendsEntity]):
    entity = DEISFinancialRatiosDividendsEntity
