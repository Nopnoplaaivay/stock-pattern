...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosProfitabilitiesEntity


class DEISFinancialRatiosProfitabilitiesRepo(BaseRepo[DEISFinancialRatiosProfitabilitiesEntity]):
    entity = DEISFinancialRatiosProfitabilitiesEntity
