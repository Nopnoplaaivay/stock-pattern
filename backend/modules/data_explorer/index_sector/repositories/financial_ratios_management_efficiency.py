...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosManagementEfficiencyEntity


class DEISFinancialRatiosManagementEfficiencyRepo(BaseRepo[DEISFinancialRatiosManagementEfficiencyEntity]):
    entity = DEISFinancialRatiosManagementEfficiencyEntity
