...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosFinancialTargetsEntity


class DEISFinancialRatiosFinancialTargetsRepo(BaseRepo[DEISFinancialRatiosFinancialTargetsEntity]):
    entity = DEISFinancialRatiosFinancialTargetsEntity
