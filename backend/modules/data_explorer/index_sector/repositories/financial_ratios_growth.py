...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosGrowthEntity


class DEISFinancialRatiosGrowthRepo(BaseRepo[DEISFinancialRatiosGrowthEntity]):
    entity = DEISFinancialRatiosGrowthEntity
