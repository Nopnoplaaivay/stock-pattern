...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosFinancialStrengthEntity


class DEISFinancialRatiosFinancialStrengthRepo(BaseRepo[DEISFinancialRatiosFinancialStrengthEntity]):
    entity = DEISFinancialRatiosFinancialStrengthEntity
