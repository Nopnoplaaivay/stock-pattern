...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosBankingRatioEntity


class DEISFinancialRatiosBankingRatioRepo(BaseRepo[DEISFinancialRatiosBankingRatioEntity]):
    entity = DEISFinancialRatiosBankingRatioEntity
