...
from backend.modules.data_explorer.index_sector.entities import DEISTradingDataEntity


class DEISTradingDataRepo(BaseRepo[DEISTradingDataEntity]):
    entity = DEISTradingDataEntity
