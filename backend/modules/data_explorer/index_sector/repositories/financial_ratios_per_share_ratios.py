...
from backend.modules.data_explorer.index_sector.entities import DEISFinancialRatiosPerShareRatiosEntity


class DEISFinancialRatiosPerShareRatiosRepo(BaseRepo[DEISFinancialRatiosPerShareRatiosEntity]):
    entity = DEISFinancialRatiosPerShareRatiosEntity
